...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL || (import.meta.env.PROD ? '' : 'http://localhost:8000')}/api/auth/register`, {
        email: email,
        password: password
      });
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Join VentureLens to validate your ideas.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl transition-all shadow-[0_0_15px_rgba(37,99,235,0.3)] hover:shadow-[0_0_25px_rgba(37,99,235,0.5)] mt-4"
          >
            Sign Up
          </button>
        </form>
